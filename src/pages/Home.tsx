    ...
    <div className="flex flex-col gap-32">
      ...
      <section className="relative min-h-screen flex items-center justify-center -mt-24 pt-24 pb-16 overflow-hidden bg-primary-900">
        ...
        <div className="container mx-auto px-4 z-10 text-center max-w-4xl">
          ...
          >
            <span className="inline-block py-1 px-3 rounded-full bg-white/20 text-white backdrop-blur-sm text-sm font-medium tracking-widest uppercase mb-8 border border-white/30 shadow-sm">
              Евпатория
            </span>
            <h1 className="text-5xl md:text-7xl lg:text-8xl text-white mb-6 leading-tight font-serif tracking-tight drop-shadow-md">
              Искусство <br />
      ...
      <section className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="relative aspect-square md:aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl shadow-primary-900/10 group">
            <img
          ...
          <div className="space-y-8">
            <h2 className="text-4xl md:text-5xl font-serif text-dark-choco leading-tight">
              Эстетика <br/>и вкус <br/><span className="italic text-primary-500">в гармонии</span>
            </h2>
            <p className="text-lg text-primary-900/70 font-light leading-relaxed">
      ...
      {/* Quick Menu Preview */}
      <section className="bg-primary-50 py-24 rounded-[3rem] mx-4 md:mx-8 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-primary-200/50 blur-[100px] rounded-full pointer-events-none mix-blend-multiply" />
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h2 className="text-4xl md:text-5xl font-serif text-dark-choco mb-16">Наши хиты</h2>
